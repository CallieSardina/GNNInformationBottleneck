...
- From https://doi.org/10.1145/3698108. 
    ...
    |  # Layers  | 3         | 4         | 5         | 6         | 7         | 8         | 9         | 10        |
    |------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
    | AUC Score  | 0.0000    | 0.0000    | 0.0000    | 0.0000    | 0.0000    | 0.9052    | 0.8959    | 0.8944    |

    #### Classifier Accuacy - Batch Size = 256

    | # Layers             | 3         | 4         | 5         | 6         | 7         | 8         | 9         | 10        |
    |----------------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
    | Training             | 0.8593    | 0.8663    | 0.8846    | 0.8759    | 0.0000    | 0.8506    | 0.8872    | 0.8631    |
    | Validation           | 0.8233    | 0.8070    | 0.8302    | 0.8047    | 0.0000    | 0.8070    | 0.8209    | 0.8093    |
    | Testing              | 0.7977    | 0.8023    | 0.7837    | 0.7814    | 0.0000    | 0.7814    | 0.8000    | 0.7884    |

    #### AUC Score - Batch Size = 256

    |  # Layers  | 3         | 4         | 5         | 6         | 7         | 8         | 9         | 10        |
    |------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
    | AUC Score  | 0.9001    | 0.8980    | 0.9018    | 0.8875    | 0.0000    | 0.8805    | 0.8920    | 0.8895    |

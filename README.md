...
- From https://doi.org/10.1145/3698108. 
    ...
    |----------------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
    | Training             | 0.8843    | 0.8631    | 0.8933    | 0.8675    | 0.8686    | 0.8924    | 0.8811    | 0.8553    |
    | Validation           | 0.8372    | 0.8047    | 0.8279    | 0.8023    | 0.8209    | 0.8488    | 0.8047    | 0.8209    |
    | Testing              | 0.7977    | 0.7953    | 0.8070    | 0.7844    | 0.8047    | 0.7953    | 0.8209    | 0.7884    |
    ...
    |  # Layers  | 3         | 4         | 5         | 6         | 7         | 8         | 9         | 10        |
    |------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
    | AUC Score  | 0.9055    | 0.8931    | 0.9027    | 0.8945    | 0.9056    | 0.9052    | 0.8959    | 0.8944    |

    #### Classifier Accuacy - Batch Size = 256

    | # Layers             | 3         | 4         | 5         | 6         | 7         | 8         | 9         | 10        |
    |----------------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
    | Training             | 0.8593    | 0.8663    | 0.8846    | 0.8759    | 0.9110    | 0.8506    | 0.8872    | 0.8631    |
    | Validation           | 0.8233    | 0.8070    | 0.8302    | 0.8047    | 0.8674    | 0.8070    | 0.8209    | 0.8093    |
    | Testing              | 0.7977    | 0.8023    | 0.7837    | 0.7814    | 0.7930    | 0.7814    | 0.8000    | 0.7884    |

    #### AUC Score - Batch Size = 256

    |  # Layers  | 3         | 4         | 5         | 6         | 7         | 8         | 9         | 10        |
    |------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
    | AUC Score  | 0.9001    | 0.8980    | 0.9018    | 0.8875    | 0.9143    | 0.8805    | 0.8920    | 0.8895    |


    #### Best Epoch
    | Batch Size | # Layers  | 3         | 4         | 5         | 6         | 7         | 8         | 9         | 10        |
    |------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
    | 128        |           | 370       | 107       | 173       | 77        | 57        | 93        | 67        | 34        |
    | 256        |           | 264       | 155       | 187       | 96        | 195       | 29        | 68        | 43        |

## Training & MI Calculation 

python3 run_gnn.py --train=1 --num_layers=3 --model=gcn --batch_size=128
...
#### GCN 3 Layer - Batch Size =  256 

![GCN 3 Layer](plots/gcn_256/infoplane_mi_log_3_256_layers_layers.png)
...
#### GCN 7 Layer - Batch Size =  256 

![GCN 7 Layer](plots/gcn_256/infoplane_mi_log_7_256_layers_layers.png)

#### GCN 8 Layer - Batch Size =  256 

![GCN 8 Layer](plots/gcn_256/infoplane_mi_log_8_256_layers_layers.png)

#### GCN 9 Layer - Batch Size =  256 

![GCN 9 Layer](plots/gcn_256/infoplane_mi_log_9_256_layers_layers.png)

#### GCN 10 Layer - Batch Size =  256 

![GCN 10 Layer](plots/gcn_256/infoplane_mi_log_10_256_layers_layers.png)
...
<table>
  ...
  <tr>
    <td><img src="plots/tsne_pca/tsne_pca_3_128.png" alt="TSNE/ PCA 3" width="150"></td>
    <td><img src="plots/tsne_pca/tsne_pca_4_128.png" alt="TSNE/ PCA 4" width="150"></td>
    <td><img src="plots/tsne_pca/tsne_pca_5_128.png" alt="TSNE/ PCA 5" width="150"></td>
    <td><img src="plots/tsne_pca/tsne_pca_6_128.png" alt="TSNE/ PCA 6" width="150"></td>
    <td><img src="plots/tsne_pca/tsne_pca_7_128.png" alt="TSNE/ PCA 7" width="150"></td>
    <td><img src="plots/tsne_pca/tsne_pca_8_128.png" alt="TSNE/ PCA 8" width="150"></td>
    <td><img src="plots/tsne_pca/tsne_pca_9_128.png" alt="TSNE/ PCA 9" width="150"></td>
    <td><img src="plots/tsne_pca/tsne_pca_10_128.png" alt="TSNE/ PCA 10" width="150"></td>
  </tr>
</table>
